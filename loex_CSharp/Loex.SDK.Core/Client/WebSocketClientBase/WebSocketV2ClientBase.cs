...
using Loex.SDK.Core.RequestBuilder;
...
namespace Loex.SDK.Core.Client.WebSocketClientBase
{
    ...
    public abstract class WebSocketV2ClientBase : AbstractWebSocketClient
    {
        ...
        public delegate void OnDataReceivedHandler(String response);
        public event OnDataReceivedHandler OnDataReceived;

        protected const string DEFAULT_HOST = "api.loex.io";
        protected const string PATH = "/ws";
        protected const string PROTOCOL = "ws";
        ...
        public WebSocketV2ClientBase(string accessKey, string secretKey, string host = DEFAULT_HOST, bool needAuth = true)
        {
            _host = host;
        ...
        {
            _WebSocket = new WebSocket($"{PROTOCOL}://{_host}{PATH}");
