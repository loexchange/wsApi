...
import (
	"fmt"
	"loex_golang/internal/gzip"
	"loex_golang/internal/model"
	"loex_golang/internal/requestbuilder"
...
func (p *WebSocketV2ClientBase) connectWebSocket() {
	var err error
	url := fmt.Sprintf("ws://%s%s", p.host, websocketV2Path)
