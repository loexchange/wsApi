...
from loex.connection.impl.websocket_watchdog import WebSocketWatchDog
from loex.connection.impl.websocket_manage import WebsocketManage
from loex.connection.impl.websocket_request import WebsocketRequest
from loex.constant.system import WebSocketDefine, ApiVersion
...
class SubscribeClient(object):
    ...
    def __init__(self, **kwargs):
        ...
        if self.__init_log and self.__init_log:
            logger = logging.getLogger("loex-client")
